...
### `select`
   Same signification as [where](operators-s-to-z.html#where)
...
[reverse](operators-n-to-r.html#reverse), 
...
[hierarchical_clustering](operators-d-to-h.html#hierarchical_clustering), 
    	
----

[//]: # (keyword|operator_simple_clustering_by_envelope_distance)
### `simple_clustering_by_envelope_distance`
   Same signification as [simple_clustering_by_distance](operators-s-to-z.html#simple_clustering_by_distance)
...
[cos](operators-b-to-c.html#cos), [tan](operators-s-to-z.html#tan), 
...
[cos_rad](operators-b-to-c.html#cos_rad), [tan_rad](operators-s-to-z.html#tan_rad), 
...
[gauss](operators-d-to-h.html#gauss), [truncated_gauss](operators-s-to-z.html#truncated_gauss), [poisson](operators-n-to-r.html#poisson), 
...
### `solid`
   Same signification as [without_holes](operators-s-to-z.html#without_holes)
    	
----

[//]: # (keyword|operator_sort)
### `sort`
   Same signification as [sort_by](operators-s-to-z.html#sort_by)
...
[group_by](operators-d-to-h.html#group_by), 
...
[target_of](operators-s-to-z.html#target_of), 
...
[graph](operators-d-to-h.html#graph), 
...
### `species_of`
   Same signification as [species](operators-s-to-z.html#species)
...
[around](operators-a-to-a.html#around), [cone](operators-b-to-c.html#cone), [line](operators-i-to-m.html#line), [link](operators-i-to-m.html#link), [norm](operators-n-to-r.html#norm), [point](operators-n-to-r.html#point), [polygon](operators-n-to-r.html#polygon), [polyline](operators-n-to-r.html#polyline), [rectangle](operators-n-to-r.html#rectangle), [square](operators-s-to-z.html#square), [triangle](operators-s-to-z.html#triangle), 
...
[split_in](operators-s-to-z.html#split_in), [split_using](operators-s-to-z.html#split_using), 
...
[split](operators-s-to-z.html#split), [split_using](operators-s-to-z.html#split_using), 
...
[split](operators-s-to-z.html#split), [split_in](operators-s-to-z.html#split_in), 
...
[around](operators-a-to-a.html#around), [cone](operators-b-to-c.html#cone), [line](operators-i-to-m.html#line), [link](operators-i-to-m.html#link), [norm](operators-n-to-r.html#norm), [point](operators-n-to-r.html#point), [polygon](operators-n-to-r.html#polygon), [polyline](operators-n-to-r.html#polyline), [super_ellipse](operators-s-to-z.html#super_ellipse), [rectangle](operators-n-to-r.html#rectangle), [square](operators-s-to-z.html#square), [circle](operators-b-to-c.html#circle), [ellipse](operators-d-to-h.html#ellipse), [triangle](operators-s-to-z.html#triangle), 
...
[mean](operators-i-to-m.html#mean), [mean_deviation](operators-i-to-m.html#mean_deviation), 
...
### `subtract_days`
   Same signification as [minus_days](operators-i-to-m.html#minus_days)
    	
----

[//]: # (keyword|operator_subtract_hours)
### `subtract_hours`
   Same signification as [minus_hours](operators-i-to-m.html#minus_hours)
    	
----

[//]: # (keyword|operator_subtract_minutes)
### `subtract_minutes`
   Same signification as [minus_minutes](operators-i-to-m.html#minus_minutes)
    	
----

[//]: # (keyword|operator_subtract_months)
### `subtract_months`
   Same signification as [minus_months](operators-i-to-m.html#minus_months)
    	
----

[//]: # (keyword|operator_subtract_ms)
### `subtract_ms`
   Same signification as [minus_ms](operators-i-to-m.html#minus_ms)
...
### `subtract_weeks`
   Same signification as [minus_weeks](operators-i-to-m.html#minus_weeks)
    	
----

[//]: # (keyword|operator_subtract_years)
### `subtract_years`
   Same signification as [minus_years](operators-i-to-m.html#minus_years)
...
[predecessors_of](operators-n-to-r.html#predecessors_of), [neighbors_of](operators-n-to-r.html#neighbors_of), 
...
[min_of](operators-i-to-m.html#min_of), [max_of](operators-i-to-m.html#max_of), [product_of](operators-n-to-r.html#product_of), [mean_of](operators-i-to-m.html#mean_of), 
...
[cos](operators-b-to-c.html#cos), [sin](operators-s-to-z.html#sin), 
...
[cos_rad](operators-b-to-c.html#cos_rad), [sin_rad](operators-s-to-z.html#sin_rad), 
...
[source_of](operators-s-to-z.html#source_of), 
...
### `TGauss`
   Same signification as [truncated_gauss](operators-s-to-z.html#truncated_gauss)
...
[//]: # (keyword|operator_to)
### `to`
   Same signification as [until](operators-s-to-z.html#until)
...
[every](operators-d-to-h.html#every), 
...
### `to_triangles`
   Same signification as [triangulate](operators-s-to-z.html#triangulate)
    	
----

[//]: # (keyword|operator_tokenize)
### `tokenize`
   Same signification as [split_with](operators-s-to-z.html#split_with)
...
[geometry](operators-d-to-h.html#geometry), 
...
[disjoint_from](operators-d-to-h.html#disjoint_from), [crosses](operators-b-to-c.html#crosses), [overlaps](operators-n-to-r.html#overlaps), [partially_overlaps](operators-n-to-r.html#partially_overlaps), [intersects](operators-i-to-m.html#intersects), 
...
[distance_between](operators-d-to-h.html#distance_between), [distance_to](operators-d-to-h.html#distance_to), [direction_between](operators-d-to-h.html#direction_between), [path_between](operators-n-to-r.html#path_between), [path_to](operators-n-to-r.html#path_to), 
...
[rotated_by](operators-n-to-r.html#rotated_by), [translated_by](operators-s-to-z.html#translated_by), 
...
[rotated_by](operators-n-to-r.html#rotated_by), [transformed_by](operators-s-to-z.html#transformed_by), 
    	
----

[//]: # (keyword|operator_translated_to)
### `translated_to`
   Same signification as [at_location](operators-a-to-a.html#at_location)
...
[gauss](operators-d-to-h.html#gauss), 
...
[directed](operators-d-to-h.html#directed), 
...
[inter](operators-i-to-m.html#inter), [+](operators-a-to-a.html#+), 
...
[lower_case](operators-i-to-m.html#lower_case), 
...
[path_between](operators-n-to-r.html#path_between), 
...
[mean](operators-i-to-m.html#mean), [median](operators-i-to-m.html#median), 
...
[min_of](operators-i-to-m.html#min_of), [max_of](operators-i-to-m.html#max_of), [sum_of](operators-s-to-z.html#sum_of), [product_of](operators-n-to-r.html#product_of), 
...
[where](operators-s-to-z.html#where), [with_min_of](operators-s-to-z.html#with_min_of), 
...
[where](operators-s-to-z.html#where), [with_max_of](operators-s-to-z.html#with_max_of), 
...
[set_verbose](operators-s-to-z.html#set_verbose), 
...
[round](operators-n-to-r.html#round), 
...
[or](operators-n-to-r.html#or), [and](operators-a-to-a.html#and), [!](operators-a-to-a.html#!), 
