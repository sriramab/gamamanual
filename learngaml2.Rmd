...
- if you want an agent1 at location A to go to a location B, then the following is a valid statement

```php
do goto target:B
```

- if you want an agent1 at location A to go to a location B with a speed of S, then the following is a valid statement

```php
do goto target:B speed:S
```

- if you want an agent1 at location A to go to a location B with a speed of S on a graph G, then the following is a valid statement
