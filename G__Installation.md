...
You can then download the right version from the [Downloads page](G__Downloads.md), expand the zip file wherever you want on your machine, and [launch GAMA](G__Launching.md).
...
GAMA requires that Java 1.6 or 1.7 be installed on your machine, approximately 200MB of disk space is available and that a minimum of RAM (4GB is recommended) is installed (to increase the portion of memory usable by GAMA, please refer to [these instructions](G__Troubleshooting#Memory_problems.md)).
<br />
...
see [the troubleshooting page](G__Troubleshooting#Ubuntu.md) for more information on workaround for problems on Unbuntu.