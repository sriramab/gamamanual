...
Some of the features of GAMA are illustrated in the videos above (more can be found [in our Youtube channel](http://www)).
...
A standalone version of the documentation, in PDF format, can be directly downloaded from [here](https://github)


## Source Code
GAMA can be [downloaded](Download) as a regular application or [built from source](https://github), which is necessary if you want to contribute to the platform.
...
Which you can also browse from the web [here](https://github).
...
* **[Alexis Drogoul](https://www)**, Senior Researcher at the [IRD](http://www), member of the [UMMISCO](http://www) International Research Unit. Mostly working on agent-based modeling and simulation. Has contributed and still contributes to the original design of the platform, including the GAML language (from the meta-model to the editor) and simulation facilities like Java2D displays.
* **[Patrick Taillandier](https://www)**, Associate Professor at the [University of Rouen](http://www), member of the [IDEES](http://www) CNRS Mixed Research Unit. Contributes since 2008 to the spatial and graph features (GIS integration, spatial operators) and to parameter space search algorithms. Currently working on new features related to graphical modeling and traffic simulation.
* **[Benoit Gaudou](http://www)**, Associate Professor at the [University Toulouse 1 Capitole](http://www), member of the [IRIT](http://www) CNRS Mixed Research Unit. Contributes since 2010 to documentation and unit test generation and coupling mathematical (ODE and PDE) and agent paradigms.
* **[Arnaud Grignard](https://www)**, software engineer and PhD fellow ([PDI-MSC](http://www)) at [UPMC](http://www). Contributes since 2011 to the development of new features related to visualization (3D Display), online analysis and interaction.
* **[Huynh Quang Nghi](https://www)**, software engineering lecturer at [CTU](http://www) and PhD fellow ([PDI-MSC](http://www)) at [UPMC](http://www). Contributes since 2012 to the development of new features related to GAML parser, coupling formalisms in EBM-ABM and ABM-ABM.
* **[Truong Minh Thai](https://www)**, software engineering lecturer at [CTU](http://www) and PhD fellow (PRJ322-MOET) at [IRIT](http://www)-[UT1](http://www). Contributes since 2012 to the development of new features related to data management and analysis.
* **[Nicolas Marilleau](http://www)**, Researcher at the [IRD](http://www), member of the [UMMISCO](http://www) International Research Unit and associate researcher at [DISC](http://disc) team of [FEMTO-ST](http://www) institute. Contributes since 2010 to the development of headless mode and the high performance computing module.
* **[Philippe Caillou](https://www)**, Associate professor at the [University Paris Sud 11](http://www), member of the [LRI](http://www) and [INRIA](http://www) project-team [TAO](https://tao). Contributes since 2012 and actually working on charts, simulation analysis and BDI agents.
* **[Vo Duc An](https://www)**, Post-doctoral Researcher, working on synthetic population generation in agent-based modelling, at the [UMMISCO](http://www) International Research Unit of the [IRD](http://www). Has contributed to bringing the platform to the Eclipse RCP environment and to the development of several features (e.g., the FIPA-compliant agent communication capability, the multi-level architecture).
* **[Truong Xuan Viet](https://www)**, software engineering lecturer at [CTU](http://www) and PhD fellow ([PDI-MSC](http://www)) at [UPMC](http://www). Contributes since 2011 to the development of new features related to R caller, online GIS (OPENGIS: Web Map Service - WMS, Web Feature Services - WMS, Google map, etc).
  * Samuel Thiriot
...
## Contact Us
The best way to get in touch with the developers of GAMA is to sign in for the [gama-platform@googlegroups.com mailing list](http://groups). If you wish to contribute to the platform, you might want, instead or in addition, to sign in for the [gama-dev@googlegroups.com mailing list](http://groups). On both lists, we generally answer quite quickly to requests.

Finally, if you think you have found a bug in GAMA, or if you absolutely need a feature that does not exist yet, it is much more efficient and time-saving for everyone (including current and future users) to create a new issue report. Please refer to [these instructions](https://github) to do so.