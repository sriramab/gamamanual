...
We consider here that the developper version of GAMA has been installed (as detailled in [this page](InstallingGitVersion.md)).
...
More details about the update of the GAMA realease are available [on the dedicated page](Updating.md).