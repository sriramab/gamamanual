...
# <font color='blue'>Formulation</font>
  * add a new parameter, **repair\_time**, that is equal to 6.
...
## Road repairing
We have to add a reflex method in the global section that is triggered every **repair\_time**. This method selects, thanks to the **with\_max\_of** operation the **road** agent with the highest **destruction\_coeff** value, then sets this value at 1.
