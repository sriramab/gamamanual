...
![Menu to install new extensions to GAMA.](images/auto_update/menu_install.png)
...
![Window where the user enters the adress of an update site and can choose plugins to install.](images/auto_update/dialog_install.png)
...
![Display of the list of available extensions.](images/auto_update/dialog_install_2.png)
...
![Warning window that can be dismissed.](images/auto_update/warning_install.png)
...
![After installation, GAMA has to be restarted.](images/auto_update/install_restart.png)
...
![Button to give access to additional preferences.](images/auto_update/open_advanced.png)
...
![Check for automatic update.](images/auto_update/prefs_update.png)
