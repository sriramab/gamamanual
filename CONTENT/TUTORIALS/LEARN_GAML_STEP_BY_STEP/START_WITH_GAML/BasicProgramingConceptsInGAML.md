...
[//]: # (Previous:OrganizationOfAModel)
[//]: # (Next:null)
[//]: # (Prerequisite:[OrganizationOfAModel])
...
In GAML language, you can use a lot of different operators. They are all listed in this [page](TODO_URL), but here are the most useful ones:
