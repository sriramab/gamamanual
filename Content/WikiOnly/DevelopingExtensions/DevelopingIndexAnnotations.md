...
This annotation contains:
  ...
  * **kinds** (set of int, empty by default): _generic symbol kinds of the parents (see [ISymbolKind.java](https://github.com/gama-platform/gama/blob/master/msi.gama.processor/src/msi/gama/precompiler/ISymbolKind.java) for more details)_.
...
This annotation contains:
  ...
  * **kind** (int): _the kind of the annotated symbol (see [ISymbolKind.java](https://github.com/gama-platform/gama/blob/master/msi.gama.processor/src/msi/gama/precompiler/ISymbolKind.java) for more details)_.
