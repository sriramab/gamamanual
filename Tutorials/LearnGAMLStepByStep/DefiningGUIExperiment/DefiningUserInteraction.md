...
An other way to define user interaction is to use the user control architecture. Please jump directly to the section [user control architecture](https://github.com/mazarsju/gama_doc_17/wiki/Tutorials/LearnGAMLStepByStep/MultiParadigmModeling/ControlArchitecture.md#user-control-architecture) if you want to learn more about this point.