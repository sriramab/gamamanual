...
[images/user_command_inside_expe.png](images/user_command_inside_expe)
...
[images/user_command_inside_species1.png](images/user_command_inside_species1)
...
[images/user_command_inside_species2.png](images/user_command_inside_species2)
...
[images/input_cmd.png](images/input_cmd)

## User Control Architecture

An other way to define user interaction is to use the user control architecture. Please jump directly to the section [user control architecture](https://github) if you want to learn more about this point.