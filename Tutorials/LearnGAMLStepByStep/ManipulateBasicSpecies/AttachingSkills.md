...
A lot of other skills are available. Some of them can be [built in skills](BuiltInSkills.md), integrated by default in GAMA, other are linked to [additional plugins](Extension.md).
