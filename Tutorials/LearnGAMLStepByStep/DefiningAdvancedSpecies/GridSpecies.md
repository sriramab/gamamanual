...
[images/grid_neighbors.png](images/grid_neighbors)
...
### grid\_value
The **grid\_value** built-in variable is used when initializing a grid from grid file (see later). It is also used for the 3D representation of [DEM](http://code)(TODO_URL).
...
[images/my_grid_model.png](images/my_grid_model)
