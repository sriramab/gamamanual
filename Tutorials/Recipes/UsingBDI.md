...
First let's create a BDI agent using the key control **simple\_bdi** (A description of all existing control architectures is available [here](https://github.com/mazarsju/gama_doc_17/wiki/References/GAMLReferences/BuiltInArchitectures.md).)
