...
There are several ways to define colors in GAML:
  * the simplest way consists in using the symbol _#_ + the color name (for a limited set of  [colors](https://github.com/mazarsju/gama_doc_17/wiki/References/GAMLReferences/Index.md#Constants_and_colors)):
```
   #blue
   #red
```
