...
This process is similar to the [choice of the workspace location](https://github) when GAMA is launched for the first time. The only preliminary step is to invoke the appropriate command ("Switch Workspace") from the "File" menu.

![images/menu_switch.png](images/menu_switch)
...
![images/dialog_switch_ok.png](images/dialog_switch_ok)
...
![images/dialog_switch_clone.png](images/dialog_switch_clone)
...
![images/clone_confirm_new.png](images/clone_confirm_new)
...
![images/clone_confirm_existing.png](images/clone_confirm_existing) 
...
![images/close_error_same.png](images/close_error_same)
...
![images/close_error_subdir.png](images/close_error_subdir)