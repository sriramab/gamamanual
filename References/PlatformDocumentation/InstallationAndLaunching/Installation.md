...
You can then download the right version from the [Downloads page](https://github.com/mazarsju/gama_doc_17/wiki/WikiOnly/Download.md), expand the zip file wherever you want on your machine, and [launch GAMA](https://github.com/mazarsju/gama_doc_17/wiki/References/PlatformDocumentation/InstallationAndLaunching/Launching.md).
