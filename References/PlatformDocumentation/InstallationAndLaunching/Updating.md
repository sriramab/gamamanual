...
![Menu to install new extensions to GAMA.](resources/images/installingAndLaunching/menu_install.png)
...
![Window where the user enters the adress of an update site and can choose plugins to install.](resources/images/installingAndLaunching/dialog_install.png)
...
![Display of the list of available extensions.](resources/images/installingAndLaunching/dialog_install_2.png)
...
![Warning window that can be dismissed.](resources/images/installingAndLaunching/warning_install.png)
...
![After installation, GAMA has to be restarted.](resources/images/installingAndLaunching/install_restart.png)
...
![Button to give access to additional preferences.](resources/images/installingAndLaunching/open_advanced.png)
...
![Check for automatic update.](resources/images/installingAndLaunching/prefs_update.png)
