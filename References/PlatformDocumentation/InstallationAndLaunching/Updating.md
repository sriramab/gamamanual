...
![Menu to install new extensions to GAMA.](images/menu_install)
...
![Window where the user enters the adress of an update site and can choose plugins to install.](images/dialog_install)
...
![Display of the list of available extensions.](images/dialog_install_2)
...
![Warning window that can be dismissed.](images/warning_install)
...
![After installation, GAMA has to be restarted.](images/install_restart)
...
![Button to give access to additional preferences.](images/open_advanced)
...
![Check for automatic update.](images/prefs_update)
