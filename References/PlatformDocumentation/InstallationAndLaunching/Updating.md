...
![Menu to install new extensions to GAMA.](resources\images/menu_install.png)
...
![Window where the user enters the adress of an update site and can choose plugins to install.](resources\images/dialog_install.png)
...
![Display of the list of available extensions.](resources\images/dialog_install_2.png)
...
![Warning window that can be dismissed.](resources\images/warning_install.png)
...
![After installation, GAMA has to be restarted.](resources\images/install_restart.png)
...
![Button to give access to additional preferences.](resources\images/open_advanced.png)
...
![Check for automatic update.](resources\images/prefs_update.png)
