...
This model illustrates how to implement an multi-level SIR model, beside coupling approach Maths and ABM.

# <font color='blue'>Formulation</font>
  * Create a SIR model via Multi-Agent on roads, and system of equation SIR inside each Buildings

# <font color='blue'>Model</font>



## SIR\_ABM initialization
...
## SIR_Maths initialization
Inside each buildings, we consider a system of equation SIR, which take number of workers arrived as parameter for S, I and R.
```
species Buildings {
...
		int pop;
